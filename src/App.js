      ...
      <div className="App">
        ...
        <div style={styles.container}>
          ...
          <div style={styles.controlTools}>
            ...
            <div>
              <label for='file-type'>Filter by file type: </label>
            ...
            <div style={{ width: "100%", padding: 10 }}>
              {myFiles.map((file) => {
                ...
                if (file.path.slice(0, filePath.length) === filePath) {
                  const fileStyle = { ...styles.file }
                  if (selectedFile && selectedFile.id === file.id) fileStyle.backgroundColor = '#ccc';
                  return (
                    <div style={fileStyle} className="files" key={file.id} onClick={() => {
